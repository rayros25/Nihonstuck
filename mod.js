...
{
    matchName: "tzPassword",
    data: {
      inputText: '',
      passwordHint: `|ヒント| <br /><span style=\"color: #008282\">まだパスワード知らな１なら、知らな１はずだと１う意味だ、バカ！戻れ！！！</span>`,
      failText: "&lt;- <b>違う！</b> 戻れ！！！",
      passwords: {
        "おうち": '009059',
        "３１か１": '009110',
     ...
     mounted(){
      let pwField = this.$el.querySelector(".passwordField")
      pwField.firstChild.innerText = "パスワード入力："
      pwField.lastChild.innerText = "<- ４な１なら戻れ！！！"
      pwField.querySelector("button").innerText = "送信"
    }
  ...
  computed(api) {
    ...
    return {
      edit(archive) {
        ...
        for (const page_num in act6act2) {
           archive.mspa.story[page_num] = {
            ...archive.mspa.story[page_num],
            ...act6act2[page_num]
          }
        ...
        for (const page_num in act6int2) {
           archive.mspa.story[page_num] = {
            ...archive.mspa.story[page_num],
            ...act6int2[page_num]
          }
